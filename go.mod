...
require (
	github.com/aquasecurity/trivy-operator v0.30.1
...
require (
	...
	github.com/kubescape/go-logger v0.0.27 // indirect
...
replace go.opentelemetry.io/otel/exporters/otlp/otlplog/otlploghttp v0.18.0 => go.opentelemetry.io/otel/exporters/otlp/otlplog/otlploghttp v0.19.0
